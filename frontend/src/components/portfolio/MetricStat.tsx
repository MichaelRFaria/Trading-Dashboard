...
export default function MetricStat({
  ...
  switch (format) {
    ...
    case 'gain': {
      /* case fallthrough used as these two cases are essentially the same other than the percentage section at the end. using case fallthrough gives no duplicated code */
    }
